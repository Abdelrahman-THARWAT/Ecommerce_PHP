...
<html lang="en">
  ...
  <body>
    <div class="container-fluid d-flex justify-content-center bg-light p-5">
      <div class="one p-5">
        <img src="../img/Granite square side table 1.png" alt="" />
        <h3 class="fw-bold">Side table</h3>
        <button class="btn border-bottom fw-bold">View More</button>
      </div>
      <div class="two p-5">
    ...
    <div class="container-fluid">
      ...
      <div class="container d-flex row-cols-4 align-items-center">
        ...
        <section class="second p-3">
          <div class="row">
            <img
              src="../img/Granite dining table with dining chair 1.png"
              alt=""
            />
          </div>
          <br />
      ...
      <br />
      <center class="m-5">
        <button class="btn border-bottom fs-5 fw-bold">View More!</button>
      </center>
    </div>
  </body>
</html>
